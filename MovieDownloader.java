...
public class MovieDownloader {
	...
	public static String[] downloadMovieData(String movie) {
		...
		try {
			...
			// Create the URL object with the url string
			URL url = new URL(urlString);

			// urlConnection is the object to interact with the site
			...
			//System.out.println(results);	// Added to see JSON
			// Remove extra JSON tags, and separate with new lines
